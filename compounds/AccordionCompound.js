...
import CloseSlimImage from '../components/Accordion/CloseSlimImage'
import AddImage from "../components/Accordion/AddImage"
  ...
  return (
    <>
      <AccordionWrapper>
        ...
        <AccordionItem>
          <AccordionHeader onClick={handleClick1} className="acc-header">
            What is Netflix?
            {FAQState1 === "open" ? <CloseSlimImage /> : <AddImage />}
          </AccordionHeader>
        ...
        <AccordionItem>
          <AccordionHeader onClick={handleClick2} className="acc-header">
            How much does Netflix coast?
            {FAQState2 === "open" ? <CloseSlimImage /> : <AddImage />}
          </AccordionHeader>
        ...
        <AccordionItem>
          <AccordionHeader onClick={handleClick3} className="acc-header">
            Where can I watch?
            {FAQState3 === "open" ? <CloseSlimImage /> : <AddImage />}
          </AccordionHeader>
        ...
        <AccordionItem>
          <AccordionHeader onClick={handleClick4} className="acc-header">
            How do I cancel?
            {FAQState4 === "open" ? <CloseSlimImage /> : <AddImage />}
          </AccordionHeader>
        ...
        <AccordionItem>
          <AccordionHeader onClick={handleClick5} className="acc-header">
            What can I watch on Netflix?
            {FAQState5 === "open" ? <CloseSlimImage /> : <AddImage />}
          </AccordionHeader>
